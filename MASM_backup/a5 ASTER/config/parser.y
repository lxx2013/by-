...
Mul_ins     : mul_tok RegE                          {
            ...
            | mul_tok num_tok                       {
                                                        ...
                                                        {   
                                                            ...
                                                            num->name = new std::string(str);
                                                            num->setvalue($2);
                                                            $$ = new MulInsNode(global->ax->h,global->ax->l,global->ax->l,num); 
                                                            $$->setLoc((Loc*)&(@$));
                                                            all_node.push_back((Node*)$$);
                                                        }  
                                                    }
...
Div_ins     : div_tok RegE                          {
            ...
            | div_tok num_tok                       {
                                                        ...
                                                        {   
                                                            ...
                                                            num->name = new std::string(str);
                                                            num->setvalue($2);
                                                            $$ = new DivInsNode(global->dx,global->ax,global->dx,global->ax,num); 
                                                            $$->setLoc((Loc*)&(@$));
                                                            all_node.push_back((Node*)$$);
                                                        }  
                                                    }
...
Block       : var_tok ':'               { 
                                            ...
                                            $$->setLoc((Loc*)&(@$));
                                            line("$$ -> memory address = %d , name:%s\n",((BlockNode*)$$),((BlockNode*)$$)->label->c_str());
                                            all_node.push_back((Node*)$$);
